...
void UpdateBondForces(System& sys){
    ...
    #pragma omp for simd
    for (long unsigned int i = 0; i < molecule.no_mol; i++)
...
System MakeWater(long unsigned int N_molecules){
    //===========================================================
    ...
    System sys;
    #pragma omp for simd
    for (long unsigned int i = 0; i < N_molecules; i++){
