...
void integrate(Water &w, const real_t dt, const real_t dx, const real_t dy, const real_t g) {
    ...
    #pragma acc parallel loop gang vector_length(1024) present(w) //test gang vector and  gang collapse
    ...
    #pragma acc parallel loop gang vector_length(1024) present(w) 
